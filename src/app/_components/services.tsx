    ...
    <section className="bg-white py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="relative">
                ...
                >
                  <article className="bg-[#1e293b] text-white rounded-2xl p-6 space-y-4 h-full flex flex-col">
                    ...
                    <div className="border-t border-gray-400 pt-4 flex items-center justify-between">
                      ...
                      <a
                        href={`https://wa.me/5511947699499?text=Olá! Vim pelo seu portifolio, vamos conversar?`}
                        target="_blank"
                        className="flex items-center justify-center gap-2 hover:bg-green-500 rounded-md px-4 py-1 duration-300"
                      >
          ...
          <button
            onClick={scrollPrev}
            className="bg-white flex items-center justify-center rounded-full shadow-lg w-10 h-10 absolute -left-2 -translate-y-1/2 top-1/2 z-10"
          >
            <ChevronLeft className="w-6 h-6 text-gray-600" />
          </button>
          <button
            onClick={scrollNext}
            className="bg-white flex items-center justify-center rounded-full shadow-lg w-10 h-10 absolute -right-2 -translate-y-1/2 top-1/2 z-10"
          >
